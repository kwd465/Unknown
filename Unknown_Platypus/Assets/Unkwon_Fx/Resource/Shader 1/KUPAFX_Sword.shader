...
Shader "KOGUN/Sword"
{
	Properties
	{
		...
		_EdgeIns("Edge Ins", Float) = 39.74
		_EdgeThinknees("Edge Thinknees", Float) = -0.9
		...
		_UV_Noise_Tex("UV_Noise_Tex", 2D) = "white" {}
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 panner32 = ( 1.0 * _Time.y * appendResult35 + uv_Vertex_Tex);
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			#endif
			float2 uv_NoiseTex01 = i.uv_texcoord * _NoiseTex01_ST.xy + _NoiseTex01_ST.zw;
			...
			float4 temp_output_104_0 = ( ( ( ( saturate( ( i.uv_texcoord.y + _EdgeThinknees ) ) * _EdgeIns ) * tex2DNode1.r ) * _Edge_Color ) + ( ( _Emi_Color * ( ( pow( saturate( ( ( 1.0 - uv_TexCoord41.x ) + staticSwitch77 ) ) , 8.0 ) * tex2D( _NoiseTex01, uv_NoiseTex01 ).r ) * 45.0 ) ) + ( _MainColor * tex2D( _Main_Tex, panner37 ) ) ) );
			...
			o.Alpha = ( i.vertexColor.a * saturate( ( ( ( tex2DNode1.r * saturate( temp_output_108_0 ) ) * saturate( ( ( tex2D( _NoiseTex01, uv_NoiseTex01 ).r + temp_output_83_0 ) * temp_output_83_0 ) ) ) * _Opacity ) ) );
		}
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.CommentaryNode;69;-2163.245,-591.6752;Inherit;False;2059.646;676.8237;Comment;17;125;124;126;40;38;39;120;62;36;65;66;37;59;61;146;144;5;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;123;-2435.638,-363.0562;Float;False;Property;_UV_Noise_Tex_UPanner;UV_Noise_Tex_UPanner;22;0;Create;True;0;0;0;False;0;False;-0.15;-0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;115;-585.3958,581.7457;Inherit;False;1122;438.0001;Dissolve_Tex;9;110;107;112;109;111;108;113;116;128;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-1091.229,501.9852;Float;False;Property;_Sword_Offset;Sword_Offset;6;0;Create;True;0;0;0;False;0;False;-0.02044457;-0.14;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-1798.732,-1163.577;Float;False;Property;_Emi_Offset;Emi_Offset;14;0;Create;True;0;0;0;False;0;False;-0.2705882;1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;71;-1819.883,451.212;Inherit;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;72;-748.9485,412.3472;Float;False;Property;_Use_Custom;Use_Custom;15;0;Create;True;0;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;144;-1994.851,-370.544;Inherit;True;Property;_TextureSample1;Texture Sample 1;25;0;Create;True;0;0;0;False;0;False;-1;be09a8cd50a86a0458240d4279757fa9;be09a8cd50a86a0458240d4279757fa9;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-1578.245,-347.675;Float;False;Property;_Noise_Val;Noise_Val;21;0;Create;True;0;0;0;False;0;False;0;0.023;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;88;-2201.919,-782.6299;Float;True;Property;_NoiseTex01;NoiseTex01;16;0;Create;True;0;0;0;False;0;False;None;74761a463678e4f52a5551e56e3e25b2;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;107;-323.2021,645.1093;Inherit;True;Property;_Dissolve_Tex;Dissolve_Tex;18;0;Create;True;0;0;0;False;0;False;-1;None;c7d564bbc661feb448e7dcb86e2aa438;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;109;-409.3958,829.7458;Float;False;Property;_Dissolve;Dissolve;19;0;Create;True;0;0;0;False;0;False;0;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1494.917,-108.4182;Float;False;Property;_Main_Tex_UPanner;Main_Tex_UPanner;4;0;Create;True;0;0;0;False;0;False;0.15;-0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-735.4817,2184.428;Float;False;Property;_Vertex_Tex_UPanner;Vertex_Tex_UPanner;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-731.4817,2266.428;Float;False;Property;_Vertex_Tex_VPanner;Vertex_Tex_VPanner;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;113;457.6042,671.7457;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;49;-493.006,-1521.523;Float;False;Property;_Emi_Color;Emi_Color;15;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,1;0.04970438,0.01121395,0.2641509,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;66;-510.6859,-449.5021;Float;False;Property;_MainColor;Main Color;3;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0.2660627,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;87;245.6417,1122.464;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-306.0406,2247.811;Float;False;Property;_Vertex_Val;Vertex_Val;11;0;Create;True;0;0;0;False;0;False;0;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;118;905.9166,727.6434;Float;False;Property;_Opacity;Opacity;0;0;Create;True;0;0;0;False;0;False;1;2.6;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;103;949.424,-1140.823;Float;False;Property;_Edge_Color;Edge_Color;7;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1,0.009314072,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;120;-1641.3,-538.9607;Inherit;True;Property;_UV_Noise_Tex;UV_Noise_Tex;20;0;Create;True;0;0;0;False;0;False;-1;None;74761a463678e4f52a5551e56e3e25b2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FloorOpNode;128;311.162,817.1119;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;138;2004.079,773.4989;Inherit;True;Property;_FXT_Noise_Normal;FXT_Noise_Normal;24;0;Create;True;0;0;0;False;0;False;-1;be09a8cd50a86a0458240d4279757fa9;be09a8cd50a86a0458240d4279757fa9;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;139;1752.71,803.8788;Float;False;Property;_Normal_Scale;Normal_Scale;26;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2792.4,-166.8513;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;KOGUN/Sword;False;False;False;False;True;True;True;True;True;True;True;True;False;False;True;False;False;False;False;False;False;Off;0;False;;0;False;;False;0;False;;0;False;;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;9;d3d11;glcore;gles;gles3;metal;vulkan;xboxone;ps4;ps5;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;False;2;5;False;;10;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.RangedFloatNode;96;321.1261,-752.1559;Float;False;Property;_EdgeThinknees;Edge Thinknees;9;0;Create;True;0;0;0;False;0;False;-0.9;-0.85;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;98;588.3203,-766.1191;Float;False;Property;_EdgeIns;Edge Ins;8;0;Create;True;0;0;0;False;0;False;39.74;39.74;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;90;-588.2675,1057.604;Inherit;False;0;88;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.25,2;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;31;-592.4816,2028.428;Inherit;False;0;29;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;36;-1255.138,-195.454;Inherit;False;0;5;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;58;-1421.379,-1015.872;Inherit;False;0;88;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.5,2;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;122;-2417.587,-268.0211;Float;False;Property;_UV_Noise_Tex_VPanner;UV_Noise_Tex_VPanner;23;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=34EDAC674E149DFB1B130385C5552BFA7BE87EB8