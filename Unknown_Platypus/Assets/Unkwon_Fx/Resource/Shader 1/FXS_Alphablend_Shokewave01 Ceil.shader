...
Shader "KOGUN/Alphablend_Shokewave ceil"
{
	Properties
	{
		...
		_Divideceil("Divide ceil", Range( 0 , 10)) = 5.007678
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 panner2 = ( 1.0 * _Time.y * appendResult6 + ( ( (tex2D( _Noise_Tex, panner48 )).rga * _Noise_Val ) + float3( appendResult55 ,  0.0 ) ).xy);
			...
			#endif
			o.Emission = ( ( ( ( ( ceil( ( tex2DNode1.r * _Divideceil ) ) / _Divideceil ) * pow( tex2DNode1.r , _Main_Pow ) ) * staticSwitch74 ) * _TintColor ) * i.vertexColor ).rgb;
			float4 uvs_FXT_Mask01 = i.uv_texcoord;
			uvs_FXT_Mask01.xy = i.uv_texcoord.xy * _FXT_Mask01_ST.xy + _FXT_Mask01_ST.zw;
			float4 temp_cast_3 = (pow( ( ( ( 1.0 - uvs_FXT_Mask01.xy.y ) * uvs_FXT_Mask01.xy.y ) * 4.0 ) , _Mask_Pow )).xxxx;
			float4 temp_cast_4 = (_Mask_Pow).xxxx;
			#ifdef _USE_MASKTEX_ON
				float4 staticSwitch42 = pow( tex2D( _FXT_Mask01, uvs_FXT_Mask01.xy ) , temp_cast_4 );
			#else
				float4 staticSwitch42 = temp_cast_3;
			#endif
			...
			#endif
			float4 temp_output_18_0 = ( i.vertexColor.a * saturate( ( ( ( tex2DNode1.r * staticSwitch42 ) * ( pow( tex2D( _Dissolve_Tex, panner75 ).r , 2.0 ) + staticSwitch73 ) ) * _Opacity ) ) );
...
Node;AmplifyShaderEditor.SamplerNode;45;-1615.049,-1121.073;Inherit;True;Property;_Noise_Tex;Noise_Tex;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;43;-2269.839,33.96401;Inherit;False;1446.815;691.7301;Mask;10;24;23;38;36;25;35;42;22;19;61;;1,1,1,1;0;0
Node;AmplifyShaderEditor.ComponentMaskNode;46;-1327.049,-1120.073;Inherit;True;True;True;False;True;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-1257.049,-903.0724;Float;False;Property;_Noise_Val;Noise_Val;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-704,-206.5;Float;False;Property;_Main_VPanner;Main_VPanner;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;52;-1043.823,-1107.539;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-2219.839,423.6942;Inherit;True;0;35;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-739.7931,416.977;Float;False;Property;_Dissove_VPanner;Dissove_VPanner;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;22;-1961.878,393.3562;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;54;-664.8569,-711.3562;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;61;-1963.504,74.38404;Inherit;False;0;35;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-1790.972,454.0323;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1702.539,317.9912;Float;False;Property;_Mask_Pow;Mask_Pow;8;0;Create;True;0;0;0;False;0;False;3.606799;3.606799;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;81;106.6933,-803.426;Float;False;Property;_Divideceil;Divide ceil;21;0;Create;True;0;0;0;False;0;False;5.007678;5.007678;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;35;-1709.31,83.964;Inherit;True;Property;_FXT_Mask01;FXT_Mask01;7;0;Create;True;0;0;0;False;0;False;-1;c1cabec419b31ac458458a4156981f34;c1cabec419b31ac458458a4156981f34;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-292.2404,-685.2042;Inherit;True;Property;_Mian_Texture;Mian_Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-1585.972,455.0323;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;32.99809,-1034.746;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;25;-1354.796,443.3402;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;36;-1387.268,107.58;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;42;-1075.025,283.2422;Float;False;Property;_Use_MaskTex;Use_MaskTex;9;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CeilOpNode;79;265.0782,-1071.323;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;228.9668,-102.8583;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;7;63,-534.5;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;80;455.7997,-1040.491;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;630.0804,-108.2249;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;74;197.3086,-250.812;Float;False;Property;_Use_Custom;Use_Custom;18;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;83;696.0173,-956.0779;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;757.2294,114.934;Float;False;Property;_Opacity;Opacity;4;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;912.2932,-107.1312;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;15;432.5813,-709.4039;Float;False;Property;_TintColor;Tint Color;6;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;755.5813,-657.4039;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;11;1128.295,-106.1312;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;2787.958,-64.41022;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;1354.052,-237.978;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=464649BD713C205C2F1679A82047F41B2C0756A4