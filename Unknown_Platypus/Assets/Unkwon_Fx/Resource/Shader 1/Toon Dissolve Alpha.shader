...
Shader "KOGUN/Toon Dissolve Alpha"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 panner42 = ( 1.0 * _Time.y * appendResult41 + uvs_ColorTex.xy);
			o.Emission = ( ( _ColorFront * tex2D( _ColorTex, panner42 ) ) * i.vertexColor ).rgb;
			float4 temp_cast_1 = (0.1).xxxx;
			float temp_output_7_0 = ( 1.0 - i.uv_texcoord.xy.y );
			...
			float2 panner2 = ( 1.0 * _Time.y * appendResult5 + uvs_MainTex.xy);
			...
			#endif
			float4 temp_output_20_0 = ( step( temp_cast_1 , pow( ( temp_output_7_0 * ( temp_output_7_0 + tex2D( _MainTex, panner2 ) ) ) , temp_cast_2 ) ) * saturate( ( tex2D( _DissolveTex, uvs_DissolveTex.xy ) + staticSwitch44 ) ) );
			o.Alpha = ( i.vertexColor.a * temp_output_20_0 ).r;
			clip( temp_output_20_0.r - _Cutoff );
		}
...
Node;AmplifyShaderEditor.CommentaryNode;46;-1541.325,643.8853;Inherit;False;1044.422;589.9367;Dissolve;7;15;45;18;44;16;17;19;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;9;-1706.931,392.7811;Inherit;True;Property;_MainTex;Main Tex;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-1308.98,929.1415;Inherit;False;Property;_Dissolve;Dissolve;9;0;Create;True;0;0;0;False;0;False;1;1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;45;-1286.071,1031.822;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;16;-1228.833,700.9429;Inherit;True;Property;_DissolveTex;Dissolve Tex;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;44;-1014.079,936.0854;Inherit;False;Property;_Keyword0;Keyword 0;11;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;21;-1271.664,-450.2756;Inherit;False;Property;_ColorFront;Color Front;5;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;2.891759,2.858971,1.10487,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7B68C9F3B7BBE598C7C8D1C54793E38B458C25F0