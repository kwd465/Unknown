...
namespace BH
{
    public class FileUtil
    {
        ...
        public static T Get<T>(Dictionary<string, string> _data, string _key, T def = default(T))
        {
            ...
            {
#if DEBUG_LOG
                Debug.LogWarning("Get[null == _temp]");
#endif
                return def;
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        return (T)((object)double.Parse(_temp));
                    }
                    ...
                    {
#if DEBUG_LOG
                        Debug.LogWarning("Get<" + typeof(T).ToString() + "> - [" + _key + "] : " + _temp);
#endif
                    }
                }
            }
            ...
            {
#if DEBUG_LOG
                Debug.LogWarning("Get< catch : " + typeof(T).ToString() + "> - [" + _key + "] : " + _temp);
#endif
            }
